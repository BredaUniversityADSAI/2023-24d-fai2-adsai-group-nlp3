...
class TestModelTraining:
    ...
    def test_load_data(self):
        ...
        self.assertIsNotNone(model_training.load_data(
            file_path, 
            dataset))
    ...
    def test_get_model(self):
        ...
        num_classes = 6
        self.assertIsNotNone(model_training.get_model(
            model_path, 
            num_classes))
    ...
    def test_preprocess_data(self):
        ...
        self.assertIsNotNone(model_training.preprocess_data(
            df, 
            tokenizer))
    ...
    def test_predict(self):
        ...
        self.assertIsNotNone(model_training.predict(
            model, 
            sentences, 
            tokenizer, 
            label_encoder))
    ...
    def test_evaluate(self):
        ...
        self.assertIsNotNone(model_training.evaluate(
            eval_data, 
            model, 
            tokenizer, 
            label_encoder))
