...
def connect_to_azure_ml(subscription_id: str, resource_group: str, workspace_name: str) -> Workspace:
    """
...
def main(args: argparse.Namespace, subscription_id: str, resource_group: str, workspace_name: str):
    ...
    if local:
        ...
        workspace = connect_to_azure_ml(subscription_id, resource_group, workspace_name)
        datastore = workspace.get_default_datastore()
        dataset = Dataset.File.from_files(path=(datastore, args.data_path))
