...
from azure.mgmt.containerinstance.models import (Container, ContainerGroup,
...
container_group = ContainerGroup(
    ...
    ip_address=IpAddress(
        ports=[Port(protocol=ContainerGroupNetworkProtocol.tcp, port=8001)],
        type="Public",
    ),
)
