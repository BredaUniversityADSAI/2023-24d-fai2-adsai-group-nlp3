...
class TestCalculateEpisodeConfidence(unittest.TestCase):
    def test_empty_scores(self):
        ...
        self.assertEqual(calculate_episode_confidence([]), 0.0, "Should return 0.0 for empty score list")
    ...
    def test_correct_average_calculation(self):
        ...
        self.assertAlmostEqual(calculate_episode_confidence(scores), expected_average, msg="Should return correct average")
