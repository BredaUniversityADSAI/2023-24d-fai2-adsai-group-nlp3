...
if __name__ == "__main__":
    ...
    predict_pipeline = model_predict(
        episode_data_path=Input(path="azureml://subscriptions/0a94de80-6d3b-49f2-b3e9-ec5818862801/resourcegroups/buas-y2/workspaces/NLP3/datastores/workspaceblobstore/paths/test_evaluation_pipeline/trimmed_ER22_AFL01_MXF.mov"),
        model_path=Input(path="azureml://locations/westeurope/workspaces/12fa2fcc-0a79-4635-bc8c-8148b17bfac6/models/testModel/versions/3"),
        tokenizer_model="roberta-base",
        max_length=128,
        decoder_path=Input(path="azureml://subscriptions/0a94de80-6d3b-49f2-b3e9-ec5818862801/resourcegroups/buas-y2/workspaces/NLP3/datastores/workspaceblobstore/paths/labels_encodings/testModel/label_decoder")
    )
