...
def main():
    ...
    train_labels_encoded, train_labels_one_hot, label_encoder = preprocess_labels(train_labels)
    train_padded, test_padded, tokenizer, max_length = tokenize_sentences(train_sentences, test_sentences)
    ...
    predicted_emotions = predict_and_evaluate(model, X_val, y_val, label_encoder)
